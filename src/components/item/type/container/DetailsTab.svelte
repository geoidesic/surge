    ...
    .px-xs
      .flexcol.tab
        ...
        .envelope
          ...
          .flexrow.left.mt-xs
            label.flex1 Contents Have Weight?
            DocumentCheckboxInput(name='system.contentHasWeight' bind:value="{$doc.system.contentHasWeight}") 
        .envelope
          ...
          .flexrow.left.mt-xs
            label.flex1 Capacity
            DocumentTextInput(type='number' step='any' name='system.capacity'  placeholder='—' bind:value="{$doc.system.capacity}")
            label.flex0 Units
            DocumentSelect( name='system.capacityUnits'  placeholder='lb.' bind:value="{$doc.system.capacityUnits}"  options="{weightUnits}")
